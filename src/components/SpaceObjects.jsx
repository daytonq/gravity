...
function SpaceObjects({ positions, canvasSize, socketId, socket }) {
  ...
  const sendData = async () => {
    ...
    const data = {
      user_id: socketId, space_objects: [
        { name: "first", mass: 1, radius: 50, position: { x: 0, y: 0 }, velocity: { x: 0, y: 0 }, movement_type: 0 },
        { name: "second", mass: 1, radius: 50, position: { x: 2, y: 2 }, velocity: { x: 0, y: 0 }, movement_type: 2 }],
